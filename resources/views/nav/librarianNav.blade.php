...
<nav class="navbar-inverse">
  <div class="container-fluid">
    <ul class="nav navbar-nav">
      ...
      <li id="student_info" class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Requests<span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="{{route('book_issue_approval')}}">Book Issue</a></li>
